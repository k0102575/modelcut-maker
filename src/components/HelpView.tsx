      ...
      <div className="help-document">
        ...
        >
          ...
          <div className="help-topic">
            <h4>화면에서 고르는 옵션</h4>
            <ul className="help-list">
              <li>`카테고리`는 상의, 하의, 원피스, 여성세트처럼 상품 종류를 고르는 옵션입니다.</li>
              <li>`배경 느낌`은 배경 사진이 없을 때만 쓰는 간단한 분위기 선택입니다.</li>
              <li>`촬영 방향`은 정면, 측면, 뒷면 중 원하는 방향을 고르는 옵션입니다.</li>
              <li>`생성 품질`은 처음에 빠르게 1크레딧으로 선택됩니다. 필요하면 균형 2, 고품질 3으로 바꿀 수 있습니다.</li>
              <li>모델은 여성, 사진 비율은 3:4로 자동 적용됩니다.</li>
            </ul>
          </div>
        ...
        >
          ...
          <div className="help-topic">
            <h4>화면에서 고르는 옵션</h4>
            <ul className="help-list">
              <li>`나이대`는 20대, 30대, 자동 선택 중 고를 수 있습니다.</li>
